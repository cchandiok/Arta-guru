    ...
    <>
      <Router>
        <Routes>
          ...
          <Route path="/markets" element={isAuthenticated ? <Markets /> : <Navigate to="/login" />} />
          <Route path="/stocks" element={isAuthenticated ? <Stocks /> : <Navigate to="/login" />} />
          ...
          <Route path="/sec-filings" element={isAuthenticated ? <SecFilings /> : <Navigate to="/login" />} />
          <Route path="/companies" element={isAuthenticated ? <Companies /> : <Navigate to="/login" />} />
          <Route path="/transactions" element={isAuthenticated ? <Transactions /> : <Navigate to="/login" />} />
          <Route path="/settings" element={isAuthenticated ? <Settings /> : <Navigate to="/login" />} />
          <Route path="/global-markets" element={isAuthenticated ? <GlobalMarkets /> : <Navigate to="/login" />} />
